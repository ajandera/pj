...
<tr>
 <td></td>
 <td>
<input type="submit" value="<?php echo $submitLabel?>" onclick="submitForm(event)">
 </td>
 </tr>
 </table>
</form>
    ...
    <script>
        function submitForm(e) {
            ...
            // URL to handle the form data (replace with your actual endpoint)
            const endpoint = 'http://localhost:8080/cv7/pridaj.php';
